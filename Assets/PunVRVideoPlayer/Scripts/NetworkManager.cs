...
namespace Networking.Pun2
{
    public class NetworkManager : MonoBehaviourPunCallbacks
    {
        ...
        public void ConnectToRoom()
        {
           ...
           // PhotonNetwork.CreateRoom("room1"); //Create a specific room - Callback OnCreateRoomFailed
           // PhotonNetwork.JoinRoom("room1"); //Join a specific room - Callback OnJoinRoomFailed
