...
{
    //[SerializeField]
    public float _brushStrokeWidth = 0.02f; //default 0.02f
    ...
    public bool skipLastRibbonPoint { 
        get { return _skipLastRibbonPoint; } 
        set { 
            if (value == _skipLastRibbonPoint) return; 
            _skipLastRibbonPoint = value; UpdateGeometry(); } 
    }
    ...
    /////
    public void ChangeStrokeSize(float n){
